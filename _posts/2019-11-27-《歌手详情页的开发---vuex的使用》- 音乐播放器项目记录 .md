...
vue Components：state中的数据可以映射到组件上来渲染组件<br>
...
使用场景：解决多个组件之间的状态共享，这些组件可能是一些关联度很低的组件，所以我们想要共享数据就比较困难<br>

比如遇到一些路由跳转场景，如果我们传递的参数很复杂的话，vuex是很好的选择<br>


vuex可以解决多个组件之间的状态共享，路由间的复杂数据传递，<br>
